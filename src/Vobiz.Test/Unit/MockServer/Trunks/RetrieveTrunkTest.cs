...
public class RetrieveTrunkTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Trunks.RetrieveTrunkAsync(
            new RetrieveTrunkRequest { AuthId = "auth_id", TrunkId = "trunk_id" }
        );
    ...
    public async Task MockServerTest_2()
    {
        ...
        Server
            .Given(
                WireMock
                    .RequestBuilders.Request.Create()
                    .WithPath("/api/v1/Account/MA_XXXXXX/trunks/trunk_XXXXXX")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
