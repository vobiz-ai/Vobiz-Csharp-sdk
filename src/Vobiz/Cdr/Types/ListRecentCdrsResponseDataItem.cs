...
[Serializable]
public record ListRecentCdrsResponseDataItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public int? HangupCauseCode { get; set; }
    ...
    public required double StreamingCost { get; set; }

    [JsonPropertyName("terminated_to")]
    public string? TerminatedTo { get; set; }
